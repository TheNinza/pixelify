...
export const DecryptPageContainer = styled(motion.div)`
  height: 100%;
  width: 100%;
  display: flex;
...
export const StartDecryptionSection = styled(motion.div)`
  position: absolute;
  width: 100%;
  display: flex;
  flex-direction: column;
...
export const StartDecryptionButton = styled(motion.div)`
  ${GlassMorphicRectangleCSS}
